									...
									<div class="panel panel-primary">
										...
										<div class="panel-body">
											...
											<form role="form" method="POST" id="theForm" action="r.php"> 
													...
													<table border="0" class="table">
														<tr>
															...
															<td>
																...
																<div class="col-md-4">
																	<input required="required"  type="text" class="form-control" placeholder="MiddleName" onkeypress="return onlyChars(event)" name="midname">
																</div>
																<div class="col-md-4">
												...
												<center><input required="required"  class="btn btn-success" type="submit" value="Submit" id="submit">
												<input required="required"  class="btn btn-danger" type="reset" value="Reset"></center>
